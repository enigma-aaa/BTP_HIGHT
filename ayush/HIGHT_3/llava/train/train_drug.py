...
class ModelArguments:
    ...
    gpm_heads: int = field(default=4)
    gpm_layers: int = field(default=2)
    gpm_dropout: float = field(default=0.1)
    gpm_pattern_size: int = field(default=5)
    gpm_num_patterns: int = field(default=8)
    gpm_pre_sample_batch_size: int = field(default=2048)
    gpm_p: float = field(default=1.0)
    gpm_q: float = field(default=1.0)
    gpm_codebook_size: int = field(default=512)
