...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/mnt/hdd/gtoken/data1/ayush/HIGHT_4/checkpoints/Graph-LLaVA-4C-hvqvae2-5ep-hlinear-fgprompt-neg-extend/MoleculeNet-llava-hvqvae2-lmsys/vicuna-7b-v1.3-finetune_lora-large")
    parser.add_argument("--dataspace", type=str, default="/mnt/hdd/gtoken/data1/ayush/HIGHT_4/data/MoleculeNet_data/")
    ...
    parser.add_argument("--graph-checkpoint-path", type=str, default="/mnt/hdd/gtoken/data1/ayush/HIGHT_4/checkpoints/hvqvae.pth")
