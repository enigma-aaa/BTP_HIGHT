...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/mnt/data1/gtoken/ayush/HIGHT_2/checkpoints/Graph-LLaVA-4C-hvqvae2-5ep-hlinear-fgprompt-neg-extend/MoleculeNet-llava-hvqvae2-lmsys/vicuna-7b-v1.3-finetune_lora-large")
    parser.add_argument("--dataspace", type=str, default="/mnt/data1/gtoken/ayush/HIGHT_2/data/MoleculeNet_data/")
    ...
    parser.add_argument("--graph-checkpoint-path", type=str, default="/mnt/data1/gtoken/ayush/HIGHT_2/checkpoints/hvqvae.pth")
