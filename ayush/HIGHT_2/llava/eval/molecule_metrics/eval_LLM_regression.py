...
openai.api_base = "http://192.168.81.81:8002/v1" # 当前部署在ctolab18上
model = "WEIGHTS/vicuna-13b-v1.5-16k/"
...
# read test
test_data = read_json("./Mol-Instructions/Molecule-oriented_Instructions/property_prediction_test.json")
