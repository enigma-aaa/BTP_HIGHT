...
def add_arguments(parser):
    ...
    parser.add_argument("--text2mol_bert_path", type=str, default="scibert_scivocab_uncased")
...
if __name__ == "__main__":
    ...
    print(result)
    print(result["BLEU-2"],result["BLEU-4"],result["ROUGE-1"],result["ROUGE-2"],result["ROUGE-L"],result["Meteor"])
    
"""
eval_result/chebi20-molcap-graphmvp-lora-10ep.jsonl

python -m llava.eval.eval_molcap \
    --molcap_result_file eval_result/chebi20-molcap-vqvae-lora-10ep.json 
    \
