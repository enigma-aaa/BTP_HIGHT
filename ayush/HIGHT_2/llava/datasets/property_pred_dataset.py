...
class PropertyPredSupervisedGraphDataset(Dataset):
    ...
    def __init__(self, 
        ...
        self.add_selfies = data_args.add_selfies
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        graph=smiles2graph(self.selfies2smiles(input_selfies),motif=self.data_args.motif_augmented,add_lap_pe=self.data_args.add_lap_pe)
        # graph=smiles2graph(input_selfies)
        sources = dict(
            conversations=[
