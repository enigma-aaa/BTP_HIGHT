    ...
    with open(args.in_file, "rt") as f:
        ...
        for i, line in enumerate(f.readlines()):
            ...
            if convert_smiles_to_graph:
                graph = smiles2graph(smi,args.motif_augmented)
...
def main(args):
    ...
    model.get_graph_tower().to(torch.float)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in-file", type=str, default="./data/data/ChEBI-20_data/test.txt")
    parser.add_argument("--answers-file", type=str, default="eval_result/answer.jsonl")
    parser.add_argument("--graph-checkpoint-path", type=str, default="./checkpoints/cvqvae-mean.pth")
...
python -m llava.eval.model_molcap \
    --model-path ./checkpoints/Graph-LLaVA-hvqvae2-4C/molcap-llava-hvqvae2-vicuna-v1-3-7b-finetune_lora \
    --in-file ./Mol-Instructions/data/ChEBI-20_data/test.txt \
    --answers-file eval_result/chebi20-molcap-hvqvae2-lora-10ep.jsonl \
    --graph-checkpoint-path ./checkpoints/hvqvae.pth \
